...
def getLocation():
	...
	longitude = driver.find_elements('xpath','//*[@id=detail-longitude"]')
	longitude = [x.text for x in longitude]
	longitude = str(longitude[0])
	latitude = driver.find_elements('xpath','//*[@id="detail-latitute"]')
...
def email(rec_email=None, text="Hello, It's F.R.I.D.A.Y. here...", sub='F.R.I.D.A.Y.'):
	...
	with smtplib.SMTP_SSL('smtp.gmail.com',465, context = context) as smtp:
		...
		smtp.sendmail(username,rec_email,em.as_string())
